...
- Expanded Profile resource toolbars use the shared compact command height and a quiet transparent
  ...
  `Add Skill`. Neither command resembles the resource policy segmented control.
