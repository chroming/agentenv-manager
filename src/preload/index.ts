...
const api: AgentEnvApi = {
  ...
  selectWorktreeScanRoot: () => ipcRenderer.invoke("dialog:select-worktree-scan-root"),
  inventoryWorktrees: () => ipcRenderer.invoke("worktrees:inventory"),
  cancelWorktreeScan: () => ipcRenderer.invoke("worktrees:cancel-scan"),
  ...
  restoreWorktree: (id) => ipcRenderer.invoke("worktrees:restore", id),
  ...
  previewProject: (projectId, agentId) => ipcRenderer.invoke("projects:preview", projectId, agentId),
  openProject: (projectId, agentId) => ipcRenderer.invoke("projects:open", projectId, agentId),
  readProjectResource: (projectId, resourceId) =>
    ipcRenderer.invoke("projects:read-resource", projectId, resourceId),
  prepareProjectInstruction: (projectId, agentId) =>
    ipcRenderer.invoke("projects:prepare-instruction", projectId, agentId),
  ...
  setSkillSourceCandidateIgnored: (input) =>
    ipcRenderer.invoke("skills:set-source-candidate-ignored", input),
  ...
  readSharedSkillAreaState: () => ipcRenderer.invoke("skills:read-shared-area"),
  setSharedSkillAreaMode: (mode) => ipcRenderer.invoke("skills:set-shared-area-mode", mode),
  ...
  readLibrarySkillUpdateChange: (input) =>
    ipcRenderer.invoke("skills:read-update-change", input),
  ...
  previewProfileComparison: (input) => ipcRenderer.invoke("profile-comparisons:preview", input),
  startProfileComparison: (input) => ipcRenderer.invoke("profile-comparisons:start", input),
  readProfileComparison: (input) => ipcRenderer.invoke("profile-comparisons:read", input),
  cancelProfileComparison: (runId) => ipcRenderer.invoke("profile-comparisons:cancel", runId),
